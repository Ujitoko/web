<?php
//読み込むcss指定
$this->Html->css('//maxcdn.bootstrapcdn.com/bootswatch/3.2.0/cerulean/bootstrap.min.css', NULL, array('inline' => false));
?>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					<li><?php echo $this->Html->link(__('Design2', true), array(
							'controller' => 'words',
							'action' => 'design2')); ?></li>
					<li><?php echo $this->Html->link(__('Design3', true), array(
							'controller' => 'words',
							'action' => 'design3')); ?></li>
					<li><?php echo $this->Html->link(__('緑茶思考ブログ', true),'http://yusuke-ujitoko.hatenablog.com/',null,null,false); ?></li>
				</ul>
